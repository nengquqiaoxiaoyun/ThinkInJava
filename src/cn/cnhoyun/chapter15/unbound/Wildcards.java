package cn.cnhoyun.chapter15.unbound;// generics/Wildcards.java
...
class SubWildcards extends Wildcards {

}

class SuperWildcards {
}

/**
 * ? extends T实例对象泛型指向 T和T的子类 get一定都是父类，set不确定具体的子类，不安全
 * ? super T实例对象泛型指向 T和T的父类 （包括object） get不确定具体的父类 父类的操作子类一定可以使用 （set）
 */
public class Wildcards extends SuperWildcards {
    // Raw argument:
