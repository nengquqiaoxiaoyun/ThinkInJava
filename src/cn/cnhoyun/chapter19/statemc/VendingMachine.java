package cn.cnhoyun.chapter19.statemc;// enums/VendingMachine.java
...
import static cn.cnhoyun.chapter19.statemc.Input.*;

enum Category {
    MONEY(NICKEL, Input.DIME, Input.QUARTER, Input.DOLLAR),
